...
def patient_registration(masculine_patient, feminine_patient, total_extra_payment, rejected_trial, total_payment_fem, total_payment_mas, complicacion_paciente):
    ...
    while user_continue == 'si':
        ...
        user_continue = input("Si desea continuar ingrese 'si', en caso contrario ingrese cualquier tecla: ").lower()
...
def main():
    ...
    print(f'La cantidad de pacientes que aceptaron el estudio fueron:{acceptence_trial}')
    print(f'La cantidad de pacientes que rechazaron el estudio fueron:{rejected_trial}')
